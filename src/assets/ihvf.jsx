...
import { Sun, Moon, Github, Linkedin, Mail, ChevronDown, GraduationCap, Award } from 'lucide-react'
...
export default function Component() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      <motion.header 
        className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-lg"
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        ...
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <ul className="flex space-x-6">
            ...
            <motion.li whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
              <button onClick={toggleTheme} className="p-1 rounded-full bg-gray-200 dark:bg-gray-700">
      ...
      <motion.footer 
        className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-lg py-6"
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.5 }}
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          <p className="text-sm">&copy; 2024 Deepak Puri Goswami. All rights reserved.</p>
...
function Home() {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center">
      ...
      >
        <motion.div 
          className="w-40 h-40 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -z-10 blur-lg opacity-70"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 180, 360],
          }}
        ...
        <img
          ...
          className="rounded-full w-40 h-40 object-cover border-4 border-white dark:border-gray-800 shadow-lg"
        />
      </motion.div>
      <motion.h2
      ...
      <motion.button
        className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-bold py-3 px-6 rounded-full shadow-lg transform transition-all duration-300 ease-in-out hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50"
  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={{ duration: 0.5 }}
      >
        <h2 className="text-4xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text">About Me</h2>
        <p className="mb-4 text-lg leading-relaxed">
          ...
          and Basic HTML,CSS and JAVA-SCRIPT.
        </p>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          ...
          >
            ...
            >
              <img className='h-full w-full' src={project.image} alt={project.title}/></motion.div>
            <div className="p-6">
      ...
      <div className="space-y-6 cursor-pointer">
        {certificates.map((cert, index) => (
          ...
          >
            ...
            <a href={cert.link} target='__blank'><div>
...
function Contact() {
  return (
    <div className="w-full max-w-md mx-auto">
      <motion.h2 
        className="text-4xl font-bold mb-8 text-center bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text"
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
      >
